...
- **Endpoint**: `GET /api/rules/evaluate` (trigger evaluation)
- **Endpoint**: `GET /api/feedback/progress` (fetch improvement score)
- **Controller**: `RuleEngineController`, `FeedbackController`
